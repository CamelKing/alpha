...
tests['dropWhile'] = [
  ...
  'null iteratee = drop by max drop count.',
  'default max drop count is length of array.',
  'using function as iteratee.',
  'using object matching as iteratee.',
  'drop nothing if wrong object type is used as iteratee.',
  'drop nothing if empty object is used as iteratee.',
  'using property(in array) matching as iteratee.',
  'drop nothing if property in array does not exist.',
  'using propperty value as iteratee.',
  ...
  'ignore any other form of iteratee e.g. promise.',
];
